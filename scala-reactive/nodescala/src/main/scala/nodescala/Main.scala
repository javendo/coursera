...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val userInterrupted: Future[String] = {
      Future.userInput("Enter a message").continue(s => "You entered... " + s)
    }
    ...
    val terminationRequested: Future[String] = {
      val f1 = Future.delay(10 seconds).continue(_ => "Server timeout!")
      val f2 = Future.userInput("Enter a message")
      Future.any(List(f1, f2))
    }
